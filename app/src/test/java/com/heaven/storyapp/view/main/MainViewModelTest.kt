...
import com.heaven.storyapp.DataDummy
import com.heaven.storyapp.MainDispatcherRule
import com.heaven.storyapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    @Mock
    private lateinit var storyRepository: GeneralRepository
    private lateinit var mainViewModel: MainViewModel
    private val token :String = "MOCK_TOKEN"
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<ListStoryItem> = mainViewModel.getPagedStories(token).getOrAwaitValue()
